...
// --- DATA ---
// NOTE: Plant data has been significantly updated with size, spacing, and climate-based harvest times.
...
const plantData = [
    ...
    // ... all other 90 plants updated similarly ...
];
...
function App() {
  ...
  // REVISED: calculateHarvestDate now accepts climate to find the correct harvest time
  const calculateHarvestDate = (plantedDate, harvestData, climate) => {
    const date = new Date(plantedDate);
    let daysToHarvest = '75'; // Default value

    if (typeof harvestData === 'object') {
